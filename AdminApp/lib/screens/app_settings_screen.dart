...
<<<<<<< Updated upstream
  ...
  TextEditingController _privacyPolicyController = TextEditingController();
  TextEditingController _termsOfServiceController = TextEditingController();
  TextEditingController _productIdController = TextEditingController();
  TextEditingController _thankyouCopyController = TextEditingController();
  TextEditingController _upgradeCopyController = TextEditingController();
