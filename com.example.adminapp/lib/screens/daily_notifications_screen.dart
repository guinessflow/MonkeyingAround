...
class DailyNotificationsScreen extends StatefulWidget {
  ...
  const DailyNotificationsScreen({super.key, this.backButton = defaultBackButton});

  @override
  _DailyNotificationsScreenState createState() => _DailyNotificationsScreenState();
}
...
class _DailyNotificationsScreenState extends State<DailyNotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection('daily_quote_notifications');
                                      ...
                                      TextButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          await FirebaseFirestore.instance
                                              .collection('daily_quote_notifications')
                                              .doc(id)
                                              .delete();
                                        },
                                      ),
